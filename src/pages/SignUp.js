  ...
  return (
    <main className='flex justify-center items-center w-full h-[100vh]'>
        <Fade left cascade>
            ...
            <img src={require('../assests/loginPage/icon2.png')} className='absolute w-[45%] top-[125px] left-[70px]  ' alt="" />
            </section>
        </Fade>
        <Fade bottom cascade>
                ...
                <article className='w-full'>
                    <form className='w-full flex flex-col gap-4' onSubmit={(e) => e.preventDefault()}>
                        <div className='w-full'>
                            <h1 className=' w-full text-[28px] drop-shadow-lg'>Sign In</h1>
                        </div>
                        <div className='w-full flex flex-col justify-start items-start'>
                            <label  htmlFor="userName">What should we call you?</label>
                            <input  type="text" className='h-[35px] outline-none border-[1px] border-solid border-black p-2 w-[100%] rounded-md' name="" id="userName" />
                        </div>
                        <div className='w-full flex flex-col justify-start items-start'>
                        ...
                        <div className='w-full flex flex-col justify-start items-start'>
                            ...
                            <input type="password" className='h-[35px] outline-none border-[1px] border-solid border-black p-2 w-[100%] rounded-md' name="" id="setPassword" />
                        </div>
                        <div className='w-full flex flex-col justify-start items-start'>
                            <label htmlFor="confirmPassword">Confirm the password</label>
                            <input type="password" className='h-[35px] outline-none border-[1px] border-solid border-black p-2 w-[100%] rounded-md' name="" id="confirmPassword" />
                        </div>
                        ...
                        <div className='w-full'>
                            <Link className='text-[#414141] underline' to="/login">Already have an account? Sign in here</Link>
                        </div>
